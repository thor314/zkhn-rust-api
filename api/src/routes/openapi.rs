...
#[openapi(
  ...
  components(schemas(
    ...
    CreateItemPayload, FavoriteStateEnum,
    GetItemResponse, ItemOrComment, ItemKind, GetItemsPageResponse, WithCommentsResponse,
    VotePayload, VoteState, FavoritePayload))

...
#[derive(Debug, Serialize, Deserialize, ToSchema, Default)]
#[schema(default = GetDeleteItemResponse::default, example=GetDeleteItemResponse::default)]
pub struct GetDeleteItemResponse {
  pub id:            Uuid,
  pub username:      Username,
  pub title:         Title,
  /// news, show, ask
...
impl From<Item> for GetDeleteItemResponse {
  fn from(item: Item) -> Self {
    Self {
      id:            item.id,
      username:      item.username,
